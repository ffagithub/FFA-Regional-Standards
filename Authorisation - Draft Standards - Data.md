...
| Type         | varchar  | The category type                         | Authorization Type |
| Type Title   | varchar  | The name of the specific type             | License            |
| Description  | text     | A description of the type                 |                    |
| Shared       | bool     | Is this shared to other members           | true               |
| Country      | char     | What country uses this type               | CK                 |
...
| Officer ID   | char | A globally unique identifier (GUID) issued by the system an Entity. In this case an Officer                                                                                     | 234e1dd7-2a7f-18fb-b8ed-ed78c3f93c2b |
| Entity ID    | char | A globally unique identifier (GUID) issued by the system to identify an Individual, Organization, Port, Vessel or Processing Plant who is being inspected, boarded or contacted | 234e1dd7-2a7f-18fb-b8ed-ed78c3f93c2b |
...
| Start             | time    | Start of Set                                                                      | 12:54 pm                             |
| End               | time    | End of Set                                                                        | 1:30 pm                              |
| Well Number       | integer | The well number that the catch was put in                                         |                                      |
