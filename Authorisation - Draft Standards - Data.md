...
| **Property**         | **Type** | **Description**                                                                                                                      | **Example**                                             |
|----------------------|----------|--------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|
| ID                   | varchar  | A globally unique identifier (GUID)                                                                                                  | 644e1dd7-2a7f-18fb-b8ed-ed78c3f92c2b                    |
...
| **Property**         | **Type** | **Description**                                              | **Example**                          |
|----------------------|----------|--------------------------------------------------------------|--------------------------------------|
| Entity ID            | integer  | A globally unique identifier (GUID)                          | 644e1dd7-2a7f-18fb-b8ed-ed78c3f92c2b |
...
Status ID  
Authorised By Entity ID

Authorised To Entity ID
...
Authorised Activity Type ID

Authorised Species

Authorised Gear Type
...
infrastructure already setup \@ FFA, WCPFC, Loyds/IMO, Maritime/Transport etc.
