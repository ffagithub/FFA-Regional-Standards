...
| Organization Type    | varchar  | What Type of Organization is this                                                       | **Options:** Company, Association, Government Organization, Non-Government, Law Enforcement Organization |
...
| Authorization Type | varchar  | A unique number generated by the database for Authorization Type | **Options:** License, Registration, Permit, Agreement |
| Condition Type     | varchar  | A unique number generated by the database for Condition Type     | **Options:** HMTC, Restriction, Exemption             |
| Condition          | varchar  | The title for the condition                                      | Foreign Fishing Vessel                                |
| Condition Details  | text     | The details of the conditions in plain text format               | This vessel may not                                   |
| Regional           | bool     | Is this condition a regional requirement                         | true                                                  |
| Country            | char     |                                                                  | CK                                                    |
...
| Authorization Type       | varchar  | A unique number generated by the database for Authorization Type                                                             | **Options:** License, Registration, Permit, Agreement                          |
| Authorized Activity Type | varchar  | The activity that is being authorized                                                                                        | **Options:** Fishing, Farming, Processing, Exporting, Transshipping, Unloading |
| Condition ID             | integer  | A globally unique identifier (GUID) for the Authorizing Entity                                                               | 234e1dd7-2a7f-18fb-b8ed-ed78c3f92c2b                                           |
| Status                   | varchar  | A unique number generated by the database for Status                                                                         | **Options:** Pending, Approved, Issued, Revoked, Reinstated                    |
...
| Supporting Documents     | varchar  | The path where a supporting document(s) are stored e.g. passports, certificate of incorporation, vessel registry certificate |                                                                                |
| Notes                    | text     |                                                                                                                              |                                                                                |
...
| Other Vessel Authorizations | varchar  | Any additional notes on other fishing vessel authorizations that were granted                                                                                                                                                                                                                                                                                                           | **Options:** Transshipment, Bunkering |
...
| Authorization ID | char     | A globally unique identifier (GUID) issued by the system to a  | 12                                                                  |
| Date Type        | varchar  | The type of date assigned to a specific authorization          | **Options:** Insurance Expiry, FFA Good Standing Expiry, VDS Expiry |
...
| Vessel Category                | varchar  | A field used to categorize a vessel as either foreign, local or locally based foreign                                                                                                                                                                                                                                                                                           | **Options:** Foreign, Locally Based Foreign, Local |
